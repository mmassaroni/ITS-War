	...
	class Habilidades{
		...
		public static function habilidadesPorPj($personaje){
			...
			while($registroHab = $registrosHab->fetch_array()){
				$objHab = new Habilidad($registroHab['id'], $registroHab['personaje'], $registroHab['numero'], $registroHab['nombre'], $registroHab['costo_energia'], $registroHab['efecto'], $registroHab['potencia'], $registroHab['alcance'], $registroHab['tipo']);
